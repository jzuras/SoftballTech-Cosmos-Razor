...
namespace Sbt.Pages.Admin.CreateDataForSelenium
{
    public class IndexModel : Sbt.Pages.Admin.AdminPageModel
    {
        ...
        private async Task CreateDataAsync()
        {
            ...
            var divisions = new Sbt.DivisionsOld[]
            {
                new Sbt.DivisionsOld()
                {
            ...
            var standings = new Sbt.StandingsOld[]
            {
                new Sbt.StandingsOld {Wins=0,Losses=0,Ties=0,OvertimeLosses=0,Percentage=0,GB=0,RunsAgainst=0,RunsScored=0,
                Organization=this._testOrganization,
            ...
            int gameID = 1;
            var schedule = new Sbt.SchedulesOld[]
            {
                #region Week 1
                #region Week 1 First Day
                new Sbt.SchedulesOld
                {
